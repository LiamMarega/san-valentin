          ...
          <div className="mt-12 space-y-8">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-6 text-center shadow-sm">
              <h3 className="font-semibold text-lg text-amber-800 mb-2">
                🎁 ¿Querés sorprender aún más?
              </h3>
              <p className="text-sm text-amber-700 mb-4 max-w-xs mx-auto">
                Enviá otra carta con un tema Premium exclusivo. Tu persona especial va a quedar sin palabras.
              </p>
              <Link
                href="/"
                className="inline-flex items-center gap-2 bg-amber-500 text-white font-semibold px-6 py-3 rounded-full hover:bg-amber-600 transition-all shadow-md"
              >
                <Sparkles className="w-4 h-4" />
                Enviar Carta Premium — $1 USD
              </Link>
            </div>

            {/* Instagram CTA */}
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-3">¿Te gustó la experiencia?</p>
              <Link
