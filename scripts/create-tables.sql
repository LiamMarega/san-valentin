...
-- v4 PayPal + multi-provider support
ALTER TABLE letters ADD COLUMN IF NOT EXISTS payment_method VARCHAR(50);
ALTER TABLE letters ADD COLUMN IF NOT EXISTS paypal_order_id VARCHAR(100);
